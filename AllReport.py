...
def generate_master_df(date_today, month_today, year_today):
    #date_today = "03"
    #month_today = "01"
    #year_today = "2019"
    ...
    temp_df = temp_df.rename(columns = {"T": "Temp", "U": "Humidity"})
...
def get_populated_map(date_today, month_today, year_today):
    masterDF = generate_master_df(date_today, month_today, year_today)
    temp_map = dict()
